...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        for var in self.domains:
            ...
            node_consistent_words = set()

            for word in self.domains[var]:
                if len(word) == var.length:
                    node_consistent_words.add(word)
    ...
    def revise(self, x, y):
        ...
        for x_word in self.domains[x].copy():
            ...
            for y_word in self.domains[y]:
                ...
                # Words must satisfy overlap
                if x_word[i] == y_word[j]:
                    found_match = True
                    break

            # if there was no possible match found
            if not found_match:
    ...
    def order_domain_values(self, var, assignment):
        ...
        for i, word in enumerate(self.domains[var]):
            ...
            unassigned_neighbors = list(
                filter(lambda neighbor: neighbor not in assignment, self.crossword.neighbors(var)))
